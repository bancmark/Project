    ...
    <>
      <div className="justify-center items-center my-16">
        ...
        <div className="flex text-white p-3 my-10">
          ...
          <div className="w-1/3 m-3 pr-2 border-r border-white cursor-pointer hover:scale-110 transition-transform duration-300 ease-in-out">
          ...
          <div className="w-1/3 m-3 border-r pr-2 border-white cursor-pointer hover:scale-110 transition-transform duration-300 ease-in-out">
          ...
          <div className="w-1/3 m-3 cursor-pointer hover:scale-110 transition-transform duration-300 ease-in-out">
